...
# Este archivo contiene las rutas y configuraciones generales del sistema
# Carpeta principal donde están todas las consolas
BASE_PATH = Path("/Users/mariaclara/Desktop/Proyectos/CONSOLAS_Promozione")
